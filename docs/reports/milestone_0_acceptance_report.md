...
Milestone 0 的目标是**冻结 docs/v1.md 作为唯一需求输入**，确认当前 v0 与目标 v1.0 的差距，并完成任务拆解。

具体目标：

1. 将 docs/v1.md 派生为可执行的跟踪文档
2. 建立 v1.0 功能验收矩阵
3. 建立 v1.0 测试计划
4. 扫描当前代码，生成 v0 差距分析
5. 拆解 v1.0 开发任务
...
| 交付物 | 路径 | 状态 | 备注 |
|---|---|---|---|
| docs/v1.md | docs/v1.md | ✅ 已存在（来源） | 本阶段输入，不可替代 |
...
- [x] **docs/v1.md 已作为唯一需求输入** - docs/v1.md 正确定义了产品定位、FR、技术方案、测试方案和验收标准
- [x] **Must Have 范围已冻结** - docs/v1.md 第 4.2 节明确 Must Have 范围
- [x] **Won't Have 范围已明确** - docs/v1.md 第 4.5 节明确 Won't Have 范围
...
✅ **范围已冻结**。docs/v1.md 作为唯一需求输入，所有 FR 已进入验收矩阵，所有 Must Have/Won't Have 边界已明确。
